            ...
            <div class="col-12">
                <div class="card-box">
                    @if($unit->type == 'Supporting and Servicing Unit')
                        <form action="{{ url('/serroom/create') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="garbage_recycling_room" class="form-control" placeholder="Enter number of garbage recycling rooms">
                            </div>

                            <div class="form-group">
                                <label for="inventory_rooms">Inventory Rooms</label>
                                <input type="number" name="inventory_rooms" class="form-control" placeholder="Enter number of inventory rooms">
                            </div>

                            <div class="form-group">
                                <label for="janitorial_room">Janitorial Room</label>
                                <input type="number" name="janitorial_room" class="form-control" placeholder="Enter number of janitorial rooms">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="loading_dock" class="form-control" placeholder="Enter number of loading docks">
                            </div>

                            <div class="form-group">
                                <label for="lobby">Lobby</label>
                                <input type="number" name="lobby" class="form-control" placeholder="Enter number of lobbies">
                            </div>

                            <div class="form-group">
                                <label for="mailroom">Mailroom</label>
                                <input type="number" name="mailroom" class="form-control" placeholder="Enter number of mailrooms">
                            </div>

                            <div class="form-group">
                                <label for="mens_bathroom">Men's Bathroom</label>
                                <input type="number" name="mens_bathroom" class="form-control" placeholder="Enter number of men's bathrooms">
                            </div>

                            <div class="form-group">
                                <label for="mens_washroom">Men's Washroom</label>
                                <input type="number" name="mens_washroom" class="form-control" placeholder="Enter number of men's washrooms">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="storage_room" class="form-control" placeholder="Enter number of storage rooms">
                            </div>

                            <div class="form-group">
                                <label for="womens_bathroom">Women's Bathroom</label>
                                <input type="number" name="womens_bathroom" class="form-control" placeholder="Enter number of women's bathrooms">
                            </div>

                            <div class="form-group">
                                <label for="womens_washroom">Women's Washroom</label>
                                <input type="number" name="womens_washroom" class="form-control" placeholder="Enter number of women's washrooms">
                            </div>

                            <div class="form-group">
                                <label for="workshop">Workshop</label>
                                <input type="number" name="workshop" class="form-control" placeholder="Enter number of workshops">
                            </div>
