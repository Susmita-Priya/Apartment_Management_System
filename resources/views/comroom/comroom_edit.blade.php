...
@section('content')
@push('title')
    <title>Edit Commercial Room</title>
@endpush
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">Edit Commercial Room</h4>
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">Edit Commercial Room</li>
                    </ol>
            ...
            <div class="col-12">
                <div class="card-box">
                    @if($unit->type == 'Commercial Unit')
                        <form action="{{ route('comroom.update', $comroom->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="bathroom" class="form-control" value="{{ $comroom->bathroom }}" placeholder="Enter number of bathrooms">
                            </div>

                            <div class="form-group">
                                <label for="officeroom">Office Room</label>
                                <input type="number" name="officeroom" class="form-control" value="{{ $comroom->office_room }}" placeholder="Enter number of office rooms">
                            </div>

                            <div class="form-group">
                                <label for="conferenceroom">Conference Room</label>
                                <input type="number" name="conferenceroom" class="form-control" value="{{ $comroom->conference_room }}" placeholder="Enter number of conference rooms">
                            </div>

                            <div class="form-group">
                                <label for="dining_room">Dining Room</label>
                                <input type="number" name="dining_room" class="form-control" value="{{ $comroom->dining_room }}" placeholder="Enter number of dining rooms">
                            </div>

                            <div class="form-group">
                                <label for="kitchen">Kitchen</label>
                                <input type="number" name="kitchen" class="form-control" value="{{ $comroom->kitchen }}" placeholder="Enter number of kitchens">
                            </div>

                            <div class="form-group">
                                <label for="laundry">Laundry</label>
                                <input type="number" name="laundry" class="form-control" value="{{ $comroom->laundry }}" placeholder="Enter number of laundries">
                            </div>

                            <div class="form-group">
                                <label for="solarium">Solarium</label>
                                <input type="number" name="solarium" class="form-control" value="{{ $comroom->solarium }}" placeholder="Enter number of solariums">
                            </div>

                            <div class="form-group">
                                <label for="storage">Storage</label>
                                <input type="number" name="storage" class="form-control" value="{{ $comroom->storage }}" placeholder="Enter number of storages">
                            </div>

                            <div class="form-group">
                                <label for="washroom">Washroom</label>
                                <input type="number" name="washroom" class="form-control" value="{{ $comroom->washroom }}" placeholder="Enter number of washrooms">
                            </div>
                            ...
                            <div id="dynamic-room-fields">
                                @foreach($comroom->extraRooms as $index => $extraRoom)
        ...
        <script>
            let index = {{ count($comroom->extraRooms) }};
