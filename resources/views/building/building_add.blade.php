                            ...
                            <div class="container mt-5">
                                <div class="col-md-12">
                                    <div class="card-box">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="total_upper_floors" class="col-form-label">Total Upper
                                                    Floors</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="total_underground_floors" class="col-form-label">Total
                                                    Underground
                                                    Floors</label>
                                                <input type="number" class="form-control" name="total_underground_floors"
                                                    id="total_underground_floors"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="common_area_id[]"
                                                    ...
                                                    @foreach ($commonAreas as $commonArea)
                                                        <option value="{{ $commonArea->id }}">{{ $commonArea->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger">
