...
@endpush
        ...
        <h1 class="d-flex justify-content-center mt-4">EDIT USER</h1>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="phn" name="phn" value="{{ $user->phn }}">
                    <span class="text-danger">
                        @error('phn')
                            {{ $message }}
                        @enderror
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="idno" name="idno" value="{{ $user->idno }}">
                    <span class="text-danger">
                        @error('idno')
                            {{ $message }}
                        @enderror
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <select id="occ_status" name="occ_status" class="form-control">
                <option value="" {{ $user->occ_status == '' ? 'selected' : '' }}>Choose</option>
                <option value="employee" {{ $user->occ_status == 'employee' ? 'selected' : '' }}>Employee</option>
                <option value="employer" {{ $user->occ_status == 'employer' ? 'selected' : '' }}>Employer</option>
                <option value="others" {{ $user->occ_status == 'others' ? 'selected' : '' }}>Others</option>
            </select>
        </div> 
        <div class="form-group col-md-6">
            <label for="occ_place" class="col-form-label">Occupation Place</label>
            <input type="text" class="form-control" id="occ_place" name="occ_place" value="{{ $user->occ_place }}">
            <span class="text-danger">
                @error('occ_place')
                    {{ $message }}
                @enderror
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="emname" name="emname" value="{{ $user->emname }}">
            <span class="text-danger">
                @error('emname')
                    {{ $message }}
                @enderror
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="emphn" name="emphn" value="{{ $user->emphn }}">
            <span class="text-danger">
                @error('emphn')
                    {{ $message }}
                @enderror
        ...
        <button type="submit" class="btn btn-primary waves-effect waves-light btn-sm" id="sa-success-updateuser">Update User Details</button>
