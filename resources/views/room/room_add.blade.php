                ...
                <div class="col-12">
                    <div class="card-box">
                        <form action="{{ route('room.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <h1 class="d-flex justify-content-center mt-4">ADD ROOM</h1>
                            <!-- Building Selection -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="amenities-container">
                                                <div class="amenity-row d-flex mb-2">
                                                    <select name="amenities[0][id]"
                                                        class="form-control amenity-select mr-2">
                                                    ...
                                                    <input type="number" name="amenities[0][quantity]"
                                                        class="form-control amenity-quantity" placeholder="Quantity"
                                                        min="1">
                                                    <button type="button" class="btn btn-danger remove-amenity ml-2"
                                                        style="display: none;">Remove</button>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-primary mt-2" id="add-amenity">Add
                                                More</button>
                                        </div>
