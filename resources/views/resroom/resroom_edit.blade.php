            ...
            <div class="col-12">
                <div class="card-box">
                    @if($unit->type == 'Residential Suite')
                        <form action="{{ route('resroom.update', $resroom->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="bedroom" class="form-control" value="{{ $resroom->bedroom }}" placeholder="Enter number of bedrooms">
                            </div>

                            <div class="form-group">
                                <label for="bathroom">Bathroom</label>
                                <input type="number" name="bathroom" class="form-control" value="{{ $resroom->bathroom }}" placeholder="Enter number of bathrooms">
                            </div>

                            <div class="form-group">
                                <label for="balcony">Balcony</label>
                                <input type="number" name="balcony" class="form-control" value="{{ $resroom->balcony }}" placeholder="Enter number of balconies">
                            </div>

                            <div class="form-group">
                                <label for="dining_room">Dining Room</label>
                                <input type="number" name="dining_room" class="form-control" value="{{ $resroom->dining_room }}" placeholder="Enter number of dining rooms">
                            </div>

                            <div class="form-group">
                                <label for="library_room">Library Room</label>
                                <input type="number" name="library_room" class="form-control" value="{{ $resroom->library_room }}" placeholder="Enter number of library rooms">
                            </div>

                            <div class="form-group">
                                <label for="kitchen">Kitchen</label>
                                <input type="number" name="kitchen" class="form-control" value="{{ $resroom->kitchen }}" placeholder="Enter number of kitchens">
                            </div>

                            <div class="form-group">
                                <label for="storeroom">Storeroom</label>
                                <input type="number" name="storeroom" class="form-control" value="{{ $resroom->storeroom }}" placeholder="Enter number of storerooms">
                            </div>

                            <div class="form-group">
                                <label for="laundry">Laundry</label>
                                <input type="number" name="laundry" class="form-control" value="{{ $resroom->laundry }}" placeholder="Enter number of laundries">
                            </div>

                            <div class="form-group">
                                <label for="solarium">Solarium</label>
                                <input type="number" name="solarium" class="form-control" value="{{ $resroom->solarium }}" placeholder="Enter number of solariums">
                            </div>

                            <div class="form-group">
                                <label for="washroom">Washroom</label>
                                <input type="number" name="washroom" class="form-control" value="{{ $resroom->washroom }}" placeholder="Enter number of washrooms">
                            </div>
