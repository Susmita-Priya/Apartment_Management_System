                            ...
                            <form action="{{ route('resroom.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="library_room" class="form-control"
                                        placeholder="Enter number of library rooms">
                                </div>
