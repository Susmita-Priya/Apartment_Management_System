...
@section('content')
@push('title')
    <title>Add Residential Room</title>
@endpush
...
<div class="content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left">Add Residential Room</h4>
                    ...
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item active">Add Residential Room</li>
                    </ol>
    ...
    <form action="{{ route('resroom.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" name="bedroom" class="form-control" placeholder="Enter number of bedrooms">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="library_room" class="form-control" placeholder="Enter number of library rooms">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="storeroom" class="form-control" placeholder="Enter number of storerooms">
        </div>
