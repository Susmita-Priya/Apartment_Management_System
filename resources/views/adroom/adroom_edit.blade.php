                ...
                <div class="col-12">
                    <div class="card-box">
                        @if ($unit->type == 'Supporting and Servicing Unit')
                            <form action="{{ route('adroom.update', $adroom->id) }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="accounting" class="form-control"
                                        value="{{ $adroom->accounting }}" placeholder="Enter number of accounting offices">
                                </div>

                                <div class="form-group">
                                    <label for="board_room">Board Room</label>
                                    <input type="number" name="board_room" class="form-control"
                                        value="{{ $adroom->board_room }}" placeholder="Enter number of board rooms">
                                </div>

                                <div class="form-group">
                                    <label for="building_manager_office">Building Manager Office</label>
                                    <input type="number" name="building_manager_office" class="form-control"
                                        value="{{ $adroom->building_manager_office }}"
                                        placeholder="Enter number of building manager offices">
                                </div>

                                <div class="form-group">
                                    <label for="business_center_room">Business Center Room</label>
                                    <input type="number" name="business_center_room" class="form-control"
                                        value="{{ $adroom->business_center_room }}"
                                        placeholder="Enter number of business center rooms">
                                </div>

                                <div class="form-group">
                                    <label for="computer_it">Computer & IT</label>
                                    <input type="number" name="computer_it" class="form-control"
                                        value="{{ $adroom->computer_it }}"
                                        placeholder="Enter number of computer & IT rooms">
                                </div>

                                <div class="form-group">
                                    <label for="conference_room">Conference Room</label>
                                    <input type="number" name="conference_room" class="form-control"
                                        value="{{ $adroom->conference_room }}"
                                        placeholder="Enter number of conference rooms">
                                </div>

                                <div class="form-group">
                                    <label for="first_aid_room">First Aid Room</label>
                                    <input type="number" name="first_aid_room" class="form-control"
                                        value="{{ $adroom->first_aid_room }}"
                                        placeholder="Enter number of first aid rooms">
                                </div>

                                <div class="form-group">
                                    <label for="human_resource">Human Resource</label>
                                    <input type="number" name="human_resource" class="form-control"
                                        value="{{ $adroom->human_resource }}"
                                        placeholder="Enter number of human resource offices">
                                </div>

                                <div class="form-group">
                                    <label for="meeting_room">Meeting Room</label>
                                    <input type="number" name="meeting_room" class="form-control"
                                        value="{{ $adroom->meeting_room }}" placeholder="Enter number of meeting rooms">
                                </div>

                                <div class="form-group">
                                    <label for="property_manager_office">Property Manager Office</label>
                                    <input type="number" name="property_manager_office" class="form-control"
                                        value="{{ $adroom->property_manager_office }}"
                                        placeholder="Enter number of property manager offices">
                                </div>

                                <div class="form-group">
                                    <label for="registration_office">Registration Office</label>
                                    <input type="number" name="registration_office" class="form-control"
                                        value="{{ $adroom->registration_office }}"
                                        placeholder="Enter number of registration offices">
                                </div>

                                <div class="form-group">
                                    <label for="sales_marketing">Sales & Marketing</label>
                                    <input type="number" name="sales_marketing" class="form-control"
                                        value="{{ $adroom->sales_marketing }}"
                                        placeholder="Enter number of sales & marketing offices">
                                </div>

                                <div class="form-group">
                                    <label for="security_concierge">Security & Concierge</label>
                                    <input type="number" name="security_concierge" class="form-control"
                                        value="{{ $adroom->security_concierge }}"
                                        placeholder="Enter number of security & concierge offices">
                                </div>

                                <div class="form-group">
                                    <label for="shipping_receiving">Shipping & Receiving</label>
                                    <input type="number" name="shipping_receiving" class="form-control"
                                        value="{{ $adroom->shipping_receiving }}"
                                        placeholder="Enter number of shipping & receiving rooms">
                                </div>

                                <div class="form-group">
                                    <label for="workshop_room">Workshop Room</label>
                                    <input type="number" name="workshop_room" class="form-control"
                                        value="{{ $adroom->workshop_room }}"
                                        placeholder="Enter number of workshop rooms">
                                </div>
