                                ...
                                <select name="type" id="type" class="form-control" required>
                                    ...
                                    @if ($floor->parking_lot)
                                        <option value="Parking Lot"
                                            {{ old('type', $unit->type) === 'Parking Lot' ? 'selected' : '' }}>Parking Lot
                                        </option>
                                    @endif

                                    @if ($floor->bike_lot)
                                        <option value="Bike Lot"
                                            {{ old('type', $unit->type) === 'Bike Lot' ? 'selected' : '' }}>Bike Lot
                                        </option>
                                    @endif

                                    @if ($floor->storage_lot)
                                        <option value="Storage Lot"
                                            {{ old('type', $unit->type) === 'Storage Lot' ? 'selected' : '' }}>Storage Lot
                                        </option>
                                    @endif

                                    @if ($floor->common_area)
                                        <option value="Common Area"
                                            {{ old('type', $unit->type) === 'Common Area' ? 'selected' : '' }}>Common Area
                                        </option>
                                    @endif
                                </select>
                            </div>
