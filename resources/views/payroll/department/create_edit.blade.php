...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <!-- end row -->
            <div class="row">
                <div class="col-md-2"><a href="{{ route('department.index') }}" class="btn btn-success text-capitalize"><i class="fa fa-list"></i> Go To {{ $page_title }} List</a></div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" name="status" id="status" required>
                                        <option value="1"
                                            @isset($department->status) {{ $department->status == 1 ? 'selected' : '' }} @endisset>
                                            Active
                                        </option>
                                        <option value="0"
                                            @isset($department->status) {{ $department->status != 1 ? 'selected' : '' }} @endisset>
