            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                            ...
                            <form action="{{ route('payroll.generate') }}" method="GET">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="year" id="" class="form-control">
                                                @for ($i = 1; $i < $year_end; $i++)
                                                    ...
                                                    @endphp
                                                    <option value="{{ $year }}"
                                                        @if (!empty($submited_year)) {{ $year == $submited_year ? 'Selected' : '' }}
                                                    @else

                                                        {{ $year == date('Y') ? 'Selected' : '' }} @endif>
                                                        {{ $year }}
                                                    </option>
                                                @endfor
                                            </select>
                                            ...
                                            <select name="month" id="" class="form-control">
                                                @if (!empty($arraymonths))
                                                    @foreach ($arraymonths as $key => $month)
                                                        <option value="{{ $key }}"
                                                            @if (!empty($submited_month)) {{ $key == $submited_month ? 'Selected' : '' }}
                                                        @else
                                                            {{ $month == date('F') ? 'Selected' : '' }} @endif>
                                                            {{ $month }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                    ...
                                    <div class="col-1">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-info mr-2 rounded">Generate</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        @if (!empty($submited_year) && !empty($submited_month))
                                            ...
                                            <tr>
                                                ...
                                                @if (!empty($salary_heads))
                                                    @foreach ($salary_heads as $salary_head)
                                                        <th
                                                            class="{{ $salary_head->head_type == 2 ? 'text-danger' : '' }}">
                                                            {{ $salary_head->name ?? '' }}
                                                        </th>
                                                    @endforeach
                                                @endif
