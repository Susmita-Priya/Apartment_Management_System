                    ...
                    <div class="card-box">
                        <div style="display:flex; justify-content:space-between;margin:0 14px; ">
                            ...
                            <h4 class="header-title m-b-15 m-t-0">
                                <a href="{{ route('employee_type.create') }}" class="btn btn-success">Add data</a>
                            </h4>
                        </div>
                                ...
                                @if (!empty($employee_types))
                                    @foreach ($employee_types as $key => $employee_type)
                                        <tr>
                                            ...
                                            <td>{{ $employee_type->remarks ?? '' }}</td>
                                            <td class="{{ $employee_type->status != 1 ? 'text-danger' : '' }}">
                                                ...
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        ...
                                                        {{-- <a class="dropdown-item "
                                                            href="{{ route('employee_type.show', ['id' => $employee_type->id]) }}"
                                                            type="submit"><i
                                                        ...
                                                        <a class="dropdown-item "
                                                            href="{{ route('employee_type.edit', $employee_type->id) }}"
                                                            type="submit"><i
                                                                class="mdi mdi-pencil m-r-10 text-muted font-18 vertical-middle"></i>
                                                            Edit
                                                        </a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('employee_type.delete', $employee_type->id) }}"
