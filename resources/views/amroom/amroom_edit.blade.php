            ...
            <div class="col-12">
                <div class="card-box">
                    @if($unit->type == 'Supporting and Servicing Unit')
                        <form action="{{ route('amroom.update', $amroom->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="balcony" class="form-control" value="{{ $amroom->balcony }}" placeholder="Enter number of balconies">
                            </div>

                            <div class="form-group">
                                <label for="business_center">Business Center</label>
                                <input type="number" name="business_center" class="form-control" value="{{ $amroom->business_center }}" placeholder="Enter number of business centers">
                            </div>

                            <div class="form-group">
                                <label for="gym">Gym</label>
                                <input type="number" name="gym" class="form-control" value="{{ $amroom->gym }}" placeholder="Enter number of gyms">
                            </div>

                            <div class="form-group">
                                <label for="hot_tub">Hot Tub</label>
                                <input type="number" name="hot_tub" class="form-control" value="{{ $amroom->hot_tub }}" placeholder="Enter number of hot tubs">
                            </div>

                            <div class="form-group">
                                <label for="laundry_room">Laundry Room</label>
                                <input type="number" name="laundry_room" class="form-control" value="{{ $amroom->laundry_room }}" placeholder="Enter number of laundry rooms">
                            </div>

                            <div class="form-group">
                                <label for="library">Library</label>
                                <input type="number" name="library" class="form-control" value="{{ $amroom->library }}" placeholder="Enter number of libraries">
                            </div>

                            <div class="form-group">
                                <label for="meeting_room">Meeting Room</label>
                                <input type="number" name="meeting_room" class="form-control" value="{{ $amroom->meeting_room }}" placeholder="Enter number of meeting rooms">
                            </div>

                            <div class="form-group">
                                <label for="mens_changing_room">Men's Changing Room</label>
                                <input type="number" name="mens_changing_room" class="form-control" value="{{ $amroom->mens_changing_room }}" placeholder="Enter number of men's changing rooms">
                            </div>

                            <div class="form-group">
                                <label for="restaurant">Restaurant</label>
                                <input type="number" name="restaurant" class="form-control" value="{{ $amroom->restaurant }}" placeholder="Enter number of restaurants">
                            </div>

                            <div class="form-group">
                                <label for="room_deck">Room Deck</label>
                                <input type="number" name="room_deck" class="form-control" value="{{ $amroom->room_deck }}" placeholder="Enter number of room decks">
                            </div>

                            <div class="form-group">
                                <label for="sauna">Sauna</label>
                                <input type="number" name="sauna" class="form-control" value="{{ $amroom->sauna }}" placeholder="Enter number of saunas">
                            </div>

                            <div class="form-group">
                                <label for="swimming_pool">Swimming Pool</label>
                                <input type="number" name="swimming_pool" class="form-control" value="{{ $amroom->swimming_pool }}" placeholder="Enter number of swimming pools">
                            </div>

                            <div class="form-group">
                                <label for="theater_room">Theater Room</label>
                                <input type="number" name="theater_room" class="form-control" value="{{ $amroom->theater_room }}" placeholder="Enter number of theater rooms">
                            </div>

                            <div class="form-group">
                                <label for="womens_changing_room">Woman's Changing Room</label>
                                <input type="number" name="womens_changing_room" class="form-control" value="{{ $amroom->womens_changing_room }}" placeholder="Enter number of woman's changing rooms">
                            </div>

                            <div class="form-group">
                                <label for="patio">Patio</label>
                                <input type="number" name="patio" class="form-control" value="{{ $amroom->patio }}" placeholder="Enter number of patios">
                            </div>
