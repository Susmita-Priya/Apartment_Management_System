                        ...
                        @if ($unit->type == 'Supporting and Servicing Unit')
                            <form action="{{ route('amroom.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gym" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="hot_tub" class="form-control"
                                        placeholder="Enter number of hot tubs">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="room_deck" class="form-control"
                                        placeholder="Enter number of room decks">
                                </div>

                                <div class="form-group">
                                    <label for="sauna">Sauna</label>
                                    <input type="number" name="sauna" class="form-control"
                                        placeholder="Enter number of saunas">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="theater_room" class="form-control"
                                        placeholder="Enter number of theater rooms">
                                </div>
