                            ...
                            <form action="{{ route('mechroom.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="boilers_room" class="form-control"
                                        placeholder="Enter number of boilers rooms">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fan_room" class="form-control"
                                        placeholder="Enter number of fan rooms">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fire_panel" class="form-control"
                                        placeholder="Enter number of fire panels">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="hydro_room" class="form-control"
                                        placeholder="Enter number of hydro rooms">
                                </div>
