        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left">Tenant</h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action = "{{ url('/') }}/tenants/create" enctype= "multipart/form-data" method = "POST">
                        @csrf
                        <div class="col-md-12">
                            <div class="card-box">
                                <h1 class="d-flex justify-content-center mt-4">ADD TENANTS</h1>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="occ_place" name="occ_place"
                                            placeholder="Enter Occupation place">
                                        <span class="text-danger">
                                            @error('occ_place')
                                                {{ $message }}
                                            @enderror
